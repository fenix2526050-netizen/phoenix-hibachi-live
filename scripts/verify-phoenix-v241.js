...
check('V241 script is cache-busted to force latest modify UI', includes(index, 'phoenix-v241-order-modification.js?v=242') && includes(v2382, 'phoenix-v241-order-modification.js?v=242'));
