...
check('V241 customer modify enforces package-specific protein portions per billable guest', includes(v241, 'proteinPortionsForPackageV241') && includes(v241, 'packageProteinPortions') && includes(v241, 'validateProteinQuantities'));
...
check('Lifecycle exposes structured editable protein/add-on fields', includes(lifecycle, 'protein_selections: b.protein_selections') && includes(lifecycle, 'proteinSelections: b.protein_selections') && includes(lifecycle, 'add_ons: b.add_ons || b.addons'));
check('Lifecycle stores structured protein selections compatibly', includes(lifecycle, 'patch.protein_selections') && includes(lifecycle, 'updateBookingCompat'));
